...
sealed class PartnerEvent with _$PartnerEvent {
  ...
  /// SEND REQUEST
  const factory PartnerEvent.sendRequest({required UserEntity user}) = _SendRequest;

  /// LOAD PARTNERSHIPS
  const factory PartnerEvent.loadPartners() = _LoadPartners;

  /// ACCEPT REQUEST
  const factory PartnerEvent.acceptRequest({required PartnershipEntity partnership}) = _AcceptRequest;
