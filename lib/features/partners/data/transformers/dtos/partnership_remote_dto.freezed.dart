...
mixin _$PartnershipRemoteDto implements DiagnosticableTreeMixin {
 ...
 String get id; String get senderId; String get receiverId; String get senderEmail; String get receiverEmail; String get senderNickname; String get receiverNickname; String get status; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,senderId,receiverId,senderEmail,receiverEmail,senderNickname,receiverNickname,status,createdAt,updatedAt);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'PartnershipRemoteDto(id: $id, senderId: $senderId, receiverId: $receiverId, senderEmail: $senderEmail, receiverEmail: $receiverEmail, senderNickname: $senderNickname, receiverNickname: $receiverNickname, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String senderId, String receiverId, String senderEmail, String receiverEmail, String senderNickname, String receiverNickname, String status, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of PartnershipRemoteDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? senderId = null,Object? receiverId = null,Object? senderEmail = null,Object? receiverEmail = null,Object? senderNickname = null,Object? receiverNickname = null,Object? status = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
switch (_that) {
case _PartnershipRemoteDto() when $default != null:
return $default(_that.id,_that.senderId,_that.receiverId,_that.senderEmail,_that.receiverEmail,_that.senderNickname,_that.receiverNickname,_that.status,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String senderId,  String receiverId,  String senderEmail,  String receiverEmail,  String senderNickname,  String receiverNickname,  String status,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PartnershipRemoteDto():
return $default(_that.id,_that.senderId,_that.receiverId,_that.senderEmail,_that.receiverEmail,_that.senderNickname,_that.receiverNickname,_that.status,_that.createdAt,_that.updatedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String senderId,  String receiverId,  String senderEmail,  String receiverEmail,  String senderNickname,  String receiverNickname,  String status,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PartnershipRemoteDto() when $default != null:
return $default(_that.id,_that.senderId,_that.receiverId,_that.senderEmail,_that.receiverEmail,_that.senderNickname,_that.receiverNickname,_that.status,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _PartnershipRemoteDto with DiagnosticableTreeMixin implements PartnershipRemoteDto {
  const _PartnershipRemoteDto({required this.id, required this.senderId, required this.receiverId, required this.senderEmail, required this.receiverEmail, required this.senderNickname, required this.receiverNickname, required this.status, required this.createdAt, required this.updatedAt});
...
/// Create a copy of PartnershipRemoteDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? senderId = null,Object? receiverId = null,Object? senderEmail = null,Object? receiverEmail = null,Object? senderNickname = null,Object? receiverNickname = null,Object? status = null,Object? createdAt = null,Object? updatedAt = null,}) {
