...
@JsonKey() Map<String, String> get accountNames {
 ...
 final  List<SettlementEntity> _incomingPendingSettlements;
@JsonKey() List<SettlementEntity> get incomingPendingSettlements {
  if (_incomingPendingSettlements is EqualUnmodifiableListView) return _incomingPendingSettlements;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_incomingPendingSettlements);
}

 final  List<SettlementEntity> _outgoingPendingSettlements;
@JsonKey() List<SettlementEntity> get outgoingPendingSettlements {
  if (_outgoingPendingSettlements is EqualUnmodifiableListView) return _outgoingPendingSettlements;
  // ignore: implicit_dynamic_type
