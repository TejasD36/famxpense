...
abstract interface class SavingsRepository {
  Future<MonthlySavingEntity> computeCurrentMonth(String accountId, double currentBalance, double goalAmount);
  ...
  Future<MonthlySavingEntity?> getSnapshot(String accountId, int year, int month);
