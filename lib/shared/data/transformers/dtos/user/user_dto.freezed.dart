...
class _UserDto with DiagnosticableTreeMixin implements UserDto {
  const _UserDto({@HiveField(0) required this.id, @HiveField(1) required this.name, @HiveField(2) required this.nickname, @HiveField(3) required this.email, @HiveField(4) this.profileImageUrl, @HiveField(5) required this.createdAt, @HiveField(6) required this.updatedAt, @HiveField(7) this.isActive = true});
