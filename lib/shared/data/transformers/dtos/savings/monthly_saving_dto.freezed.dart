...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'MonthlySavingDto(id: $id, accountId: $accountId, year: $year, month: $month, goalAmount: $goalAmount, savedAmount: $savedAmount, openingBalance: $openingBalance, closingBalance: $closingBalance, achievementPercent: $achievementPercent, isCompleted: $isCompleted, userId: $userId, syncStatus: $syncStatus)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String accountId, @HiveField(2)  int year, @HiveField(3)  int month, @HiveField(4)  double goalAmount, @HiveField(5)  double savedAmount, @HiveField(6)  double openingBalance, @HiveField(7)  double closingBalance, @HiveField(8)  double achievementPercent, @HiveField(9)  bool isCompleted, @HiveField(10)  String userId, @HiveField(11)  SyncStatus syncStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MonthlySavingDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String accountId, @HiveField(2)  int year, @HiveField(3)  int month, @HiveField(4)  double goalAmount, @HiveField(5)  double savedAmount, @HiveField(6)  double openingBalance, @HiveField(7)  double closingBalance, @HiveField(8)  double achievementPercent, @HiveField(9)  bool isCompleted, @HiveField(10)  String userId, @HiveField(11)  SyncStatus syncStatus)  $default,) {final _that = this;
switch (_that) {
case _MonthlySavingDto():
...
class _MonthlySavingDto with DiagnosticableTreeMixin implements MonthlySavingDto {
  const _MonthlySavingDto({@HiveField(0) required this.id, @HiveField(1) required this.accountId, @HiveField(2) required this.year, @HiveField(3) required this.month, @HiveField(4) required this.goalAmount, @HiveField(5) required this.savedAmount, @HiveField(6) required this.openingBalance, @HiveField(7) required this.closingBalance, @HiveField(8) required this.achievementPercent, @HiveField(9) this.isCompleted = false, @HiveField(10) this.userId = '', @HiveField(11) this.syncStatus = SyncStatus.synced});
