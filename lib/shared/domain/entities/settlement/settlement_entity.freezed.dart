...
mixin _$SettlementEntity implements DiagnosticableTreeMixin {
 ...
 String get id; String get fromUserId; String get toUserId; double get amount; SettlementStatus get status; DateTime get createdAt; DateTime? get confirmedAt; List<String>? get relatedExpenseIds; String? get accountId;
...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'SettlementEntity(id: $id, fromUserId: $fromUserId, toUserId: $toUserId, amount: $amount, status: $status, createdAt: $createdAt, confirmedAt: $confirmedAt, relatedExpenseIds: $relatedExpenseIds, accountId: $accountId)';
}
...
@useResult
$Res call({
 String id, String fromUserId, String toUserId, double amount, SettlementStatus status, DateTime createdAt, DateTime? confirmedAt, List<String>? relatedExpenseIds, String? accountId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fromUserId,  String toUserId,  double amount,  SettlementStatus status,  DateTime createdAt,  DateTime? confirmedAt,  List<String>? relatedExpenseIds,  String? accountId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettlementEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fromUserId,  String toUserId,  double amount,  SettlementStatus status,  DateTime createdAt,  DateTime? confirmedAt,  List<String>? relatedExpenseIds,  String? accountId)  $default,) {final _that = this;
switch (_that) {
case _SettlementEntity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fromUserId,  String toUserId,  double amount,  SettlementStatus status,  DateTime createdAt,  DateTime? confirmedAt,  List<String>? relatedExpenseIds,  String? accountId)?  $default,) {final _that = this;
switch (_that) {
case _SettlementEntity() when $default != null:
return $default(_that.id,_that.fromUserId,_that.toUserId,_that.amount,_that.status,_that.createdAt,_that.confirmedAt,_that.relatedExpenseIds,_that.accountId);case _:
  return null;
...
class _SettlementEntity with DiagnosticableTreeMixin implements SettlementEntity {
  const _SettlementEntity({required this.id, required this.fromUserId, required this.toUserId, required this.amount, required this.status, required this.createdAt, this.confirmedAt, final  List<String>? relatedExpenseIds, this.accountId}): _relatedExpenseIds = relatedExpenseIds;
