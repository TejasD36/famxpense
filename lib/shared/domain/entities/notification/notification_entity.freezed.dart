...
/// @nodoc
mixin _$NotificationEntity implements DiagnosticableTreeMixin {

 String get id; String get userId; NotificationType get type; String get title; String get message; String? get relatedId; DateTime get createdAt; bool get isRead;
...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'NotificationEntity(id: $id, userId: $userId, type: $type, title: $title, message: $message, relatedId: $relatedId, createdAt: $createdAt, isRead: $isRead)';
}
...
@useResult
$Res call({
 String id, String userId, NotificationType type, String title, String message, String? relatedId, DateTime createdAt, bool isRead
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  NotificationType type,  String title,  String message,  String? relatedId,  DateTime createdAt,  bool isRead)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  NotificationType type,  String title,  String message,  String? relatedId,  DateTime createdAt,  bool isRead)  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  NotificationType type,  String title,  String message,  String? relatedId,  DateTime createdAt,  bool isRead)?  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.userId,_that.type,_that.title,_that.message,_that.relatedId,_that.createdAt,_that.isRead);case _:
  return null;
...
class _NotificationEntity with DiagnosticableTreeMixin implements NotificationEntity {
  const _NotificationEntity({required this.id, required this.userId, required this.type, required this.title, required this.message, this.relatedId, required this.createdAt, this.isRead = false});
