...
_ExpenseEntity _$ExpenseEntityFromJson(Map<String, dynamic> json) => _ExpenseEntity(
  ...
  participants: (json['participants'] as List<dynamic>).map((e) => ExpenseParticipantEntity.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$ExpenseEntityToJson(_ExpenseEntity instance) => <String, dynamic>{
  'id': instance.id,
